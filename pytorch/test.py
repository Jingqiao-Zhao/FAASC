...
def inference_validation():
    ...
    evaluator.evaluate(data_type='evaluate', source="a", verbose=True, pca=True,pair=False)
    evaluator.evaluate(data_type='evaluate', source="b", verbose=True, pca=True, pair=False)
    evaluator.evaluate(data_type='evaluate', source="s4", verbose=True, pca=True, pair=False)
