...
from pytorch.evaluate2 import Evaluator, StatisticsContainer
...
def inference_validation():
    ...
    evaluator.evaluate(data_type='evaluate', source="a", verbose=True, pca=True)
    evaluator.evaluate(data_type='evaluate', source='b', verbose=True, pca=True)
    evaluator.evaluate(data_type='evaluate', source='s4', verbose=True, pca=True)
